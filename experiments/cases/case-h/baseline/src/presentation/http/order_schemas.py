...
from src.domain.entities.order import Order, OrderLine
...
class OrderLineRequestSchema(BaseModel):
    ...
    def to_domain(self) -> OrderLine:
        return OrderLine(self.sku, self.quantity, self.unit_price_cents)
...
class CreateOrderRequestSchema(BaseModel):
    ...
    def to_domain(self, order_id: str) -> Order:
...
class OrderResponseSchema(BaseModel):
    ...
    def from_domain(cls, order: Order) -> "OrderResponseSchema":
        return cls(
            ...
            line_items=[OrderLineResponseSchema(sku=line.sku, quantity=line.quantity, unit_price_cents=line.unit_price_cents) for line in order.line_items],
        )
